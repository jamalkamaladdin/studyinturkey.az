		...
		<div class="sit-container relative pt-16 pb-28">
			<div class="max-w-2xl">
				<div class="mb-6 flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1.5 w-fit">
					...
					<span class="text-[12px] font-semibold text-white/60"><?php echo esc_html( $total ); ?>+ <?php sit_esc_html_e( 'archive.prog.available', 'proqram mövcuddur' ); ?></span>
				</div>
					...
					<form action="<?php echo esc_url( $action ); ?>" method="get" class="sticky top-[140px] rounded-2xl border border-gray-200/60 bg-white p-5">
						...
						<div class="mb-6">
							...
							<div class="flex gap-2">
								<input type="number" name="sit_price_min" value="<?php echo esc_attr( $cur_pmin ); ?>" placeholder="<?php echo esc_attr( sit__( 'filter.price.min', 'Min' ) ); ?>" class="w-1/2 rounded-lg border border-gray-100 bg-gray-50 px-3 py-2 text-[12px] text-gray-600 outline-none" />
								<input type="number" name="sit_price_max" value="<?php echo esc_attr( $cur_pmax ); ?>" placeholder="<?php echo esc_attr( sit__( 'filter.price.max', 'Maks' ) ); ?>" class="w-1/2 rounded-lg border border-gray-100 bg-gray-50 px-3 py-2 text-[12px] text-gray-600 outline-none" />
							</div>
						</div>
						<div class="mb-6">
