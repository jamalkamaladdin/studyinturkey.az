		...
		<div class="sit-container max-w-4xl">
					...
					<div class="relative z-10 flex flex-col items-center justify-between gap-5 md:flex-row">
						<div>
							<div class="mb-2 flex items-center gap-2">
								...
								<h3 class="text-[18px] font-bold"><?php sit_esc_html_e( 'prog.scholarship.heading', 'Eksklüziv Təqaüd Qiyməti' ); ?></h3>
							</div>
							<p class="text-[13px] font-medium text-white/40"><?php sit_esc_html_e( 'prog.scholarship.desc', 'Bu endirimli tələbə haqqını təmin etmək üçün bizimlə müraciət edin.' ); ?></p>
						</div>
						<div class="w-full rounded-xl border border-white/[0.08] bg-white/[0.06] p-5 backdrop-blur-sm md:w-auto">
							<?php if ( $fee_ref ) : ?>
								<span class="mb-1 block text-[12px] font-medium text-white/30 line-through"><?php sit_esc_html_e( 'prog.official.fee', 'Rəsmi Ödəniş:' ); ?> $<?php echo esc_html( number_format_i18n( $fee_ref, 0 ) ); ?> / <?php esc_html_e( 'il', 'studyinturkey' ); ?></span>
							<?php endif; ?>
			...
			<?php if ( $content ) : ?>
				<div class="mt-5 rounded-2xl border border-gray-200/60 bg-white p-6 md:p-8">
					<h2 class="mb-4 border-b border-gray-100 pb-4 text-[20px] font-bold text-[#0a1a1b]"><?php sit_esc_html_e( 'prog.overview.heading', 'Proqrama Ümumi Baxış' ); ?></h2>
