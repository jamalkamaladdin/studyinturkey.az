...
<footer class="mt-auto bg-[#0d4f52] text-white">
	...
	<div class="border-b border-white/10 bg-[#0a3d3f]">
		<div class="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 py-12 sm:px-6 md:flex-row">
			<div>
				<h3 class="mb-1 text-2xl font-extrabold" style="line-height:1.3"><?php sit_esc_html_e( 'footer.cta.heading', 'Türkiyədə təhsilə başlamağa hazırsınız?' ); ?></h3>
				<p class="text-[15px] text-white/70"><?php sit_esc_html_e( 'footer.cta.desc', 'Təhsil mütəxəssislərimizdən pulsuz məsləhət alın.' ); ?></p>
			</div>
			<a href="<?php echo esc_url( $contact ); ?>" class="flex items-center gap-2 whitespace-nowrap rounded-xl bg-[#ff3131] px-8 py-3.5 text-[15px] font-bold text-white shadow-lg shadow-red-900/30 transition-all hover:bg-[#e02020]">
				<?php sit_esc_html_e( 'footer.cta.btn', 'Başlayın' ); ?>
	...
	<div class="sit-container px-4 pt-14 pb-8 sm:px-6">
		...
		<div class="flex flex-col items-center justify-between gap-4 text-[13px] text-white/60 md:flex-row">
			<p>&copy; <?php echo esc_html( $year . ' ' . get_bloginfo( 'name', 'display' ) ); ?>. <?php sit_esc_html_e( 'footer.rights', 'Bütün hüquqlar qorunur.' ); ?></p>
			<div class="flex gap-6">
				<a href="#" class="transition hover:text-white"><?php sit_esc_html_e( 'footer.privacy', 'Gizlilik Siyasəti' ); ?></a>
				<a href="#" class="transition hover:text-white"><?php sit_esc_html_e( 'footer.terms', 'İstifadə Şərtləri' ); ?></a>
			</div>
		</div>
	</div>
</footer>
