		...
		<div class="relative mx-auto max-w-7xl px-4 pt-16 pb-28 sm:px-6">
			<div class="max-w-2xl">
				<div class="mb-6 flex items-center gap-3">
					...
					<span class="text-[13px] font-semibold uppercase tracking-[0.2em] text-white/40"><?php esc_html_e( 'Get in Touch', 'studyinturkey' ); ?></span>
				</div>
				<h1 class="mb-4 text-[42px] tracking-[-0.03em] text-white md:text-[56px]" style="line-height:1.1"><?php the_title(); ?></h1>
				<p class="max-w-lg text-[17px] leading-relaxed text-white/40"><?php esc_html_e( 'Have questions about studying in Turkey? Our team is here to help you every step of the way.', 'studyinturkey' ); ?></p>
			</div>
		</div>
	</div>
			...
			<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
				<div class="space-y-3 lg:col-span-1">
					...
					$items = [
						...
						['<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',__('İş saatları','studyinturkey'),[__('Mon-Fri: 09:00-18:00','studyinturkey'),__('Sat: 10:00-14:00','studyinturkey')],'from-[#ff3131] to-rose-600'],
					];
					foreach ($items as $c) : ?>
				...
				<div class="rounded-2xl border border-gray-200/60 bg-white p-7 shadow-sm md:p-10 lg:col-span-2">
					<h2 class="mb-2 text-[24px] text-[#0a1a1b]"><?php esc_html_e( 'Send us a Message', 'studyinturkey' ); ?></h2>
					<p class="mb-7 text-[14px] text-gray-400"><?php esc_html_e( "We'll get back to you within 24 hours.", 'studyinturkey' ); ?></p>
