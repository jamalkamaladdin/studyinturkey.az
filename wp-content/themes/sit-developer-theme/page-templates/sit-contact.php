		...
		<div class="relative mx-auto max-w-7xl px-4 pt-16 pb-28 sm:px-6">
			<div class="max-w-2xl">
				<div class="mb-6 flex items-center gap-3">
					...
					<span class="text-[13px] font-semibold uppercase tracking-[0.2em] text-white/40"><?php sit_esc_html_e( 'contact.badge', 'Əlaqə' ); ?></span>
				</div>
				<h1 class="mb-4 text-[42px] tracking-[-0.03em] text-white md:text-[56px]" style="line-height:1.1"><?php the_title(); ?></h1>
				<p class="max-w-lg text-[17px] leading-relaxed text-white/40"><?php sit_esc_html_e( 'contact.hero.desc', 'Türkiyədə təhsil haqqında suallarınız var? Komandamız hər addımda sizə kömək etməyə hazırdır.' ); ?></p>
			</div>
		</div>
	</div>
		...
		<div class="mx-auto max-w-7xl px-4 pb-24 -mt-12 sm:px-6">
			<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
				<div class="space-y-3 lg:col-span-1">
					<?php
					$items = [
						['<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0zM19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z"/></svg>',sit__('contact.office','Ofisimiz'),[$address?:sit__('contact.office.addr','Bakı, Azərbaycan')],'from-brand-700 to-teal-600'],
						['<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z"/></svg>',sit__('contact.phone','Telefon'),[$phone],'from-[#ff3131] to-rose-600'],
						['<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>',sit__('contact.email','Email'),[$email],'from-brand-700 to-teal-600'],
						['<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',sit__('contact.hours','İş saatları'),[sit__('contact.hours.weekday','B.e-Cümə: 09:00-18:00'),sit__('contact.hours.saturday','Şənbə: 10:00-14:00')],'from-[#ff3131] to-rose-600'],
					];
					foreach ($items as $c) : ?>
				...
				<div class="rounded-2xl border border-gray-200/60 bg-white p-7 shadow-sm md:p-10 lg:col-span-2">
					<h2 class="mb-2 text-[24px] text-[#0a1a1b]"><?php sit_esc_html_e( 'contact.form.heading', 'Bizə Mesaj Göndərin' ); ?></h2>
					<p class="mb-7 text-[14px] text-gray-400"><?php sit_esc_html_e( 'contact.form.desc', '24 saat ərzində sizinlə əlaqə saxlayacağıq.' ); ?></p>
